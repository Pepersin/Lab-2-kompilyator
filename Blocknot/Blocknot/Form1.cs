...
namespace Blocknot
{
    public partial class Form1 : Form
    {
        ...
        {
            string helpFilePath = "C:\\Users\\Максим\\Desktop\\Blocknot\\Blocknot\\help.html"; // Убедитесь, что файл находится в корне проекта или укажите полный путь
        ...
        {
            // Получаем текст из InputRichTextBox
            string inputText = textBox.Text;

            // Выполняем лексический анализ с использованием класса Analyzer
            string analysisResult = Analyzer.Analyze(inputText);

            // Выводим результат в ResultRichTextBox
